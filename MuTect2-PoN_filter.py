...
for line in file:
	...
	if not re.search("^#",line):
		...
		if not re.search('str_contraction', filters) and not re.search('t_lod_fstar', filters) and not re.search('triallelic_site', filters) and not re.search('panel_of_normals', filters):
