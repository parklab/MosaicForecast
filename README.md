...
```
PLease note that "${your_local_directory}:/MF" is your local mosaicforecast directory. After doing the step above, you would attach your local directory to the docker image, and the attached directory in the docker image would be "/MF".
```
