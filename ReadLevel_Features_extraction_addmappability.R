...
if (length(args)!=4) {
  stop("Rscript ReadLevel_Features_extraction.R input_file(feature_list_frompython) output_file(feature_list_R) read_length(int) type(pvalue||effectsize)
...
if (type=="pvalue"){
	...
	my.wilcox.effectsize <- function(...) {
		obj<-try(wilcox.test(...), silent=TRUE)
		#if (is(obj, "try-error")) return(NA) else return(obj$statistic)
		if (attr(obj,"class")=="try-error") return(NA) else return(obj$estimate) 
	}
	...
	my.wilcox.p <- function(x)
	{
	       ref_pos=as.numeric(unlist(strsplit(as.character(x[2]),",")))
	       alt_pos=as.numeric(unlist(strsplit(as.character(x[3]),",")))
	       #round(wilcox.test(ref_pos,alt_pos,conf.int=TRUE)$estimate,5)
		e=my.wilcox.effectsize(ref_pos,alt_pos,conf.int=TRUE)
		if (!is.na(e)){
			e<-e/sqrt(length(ref_pos)+length(alt_pos))
		}
		e
	}
	input$querypos_p=apply(input,1,my.wilcox.p)
	...
	my.wilcox.p <- function(x)
	{
	       ...
	       alt_pos=as.numeric(unlist(strsplit(as.character(x[7]),",")))
	       #round(wilcox.test(ref_pos,alt_pos,conf.int=TRUE)$estimate,5)
		#round(my.wilcox.effectsize(ref_pos,alt_pos,conf.int=TRUE),5)
		e=my.wilcox.effectsize(ref_pos,alt_pos,conf.int=TRUE)
		if (!is.na(e)){
			e<-e/sqrt(length(ref_pos)+length(alt_pos))
		}
	...
	my.wilcox.p <- function(x)
	{
	       ref_mapq=as.numeric(unlist(strsplit(as.character(x[8]),",")))
	       alt_mapq=as.numeric(unlist(strsplit(as.character(x[9]),",")))
	       #round(wilcox.test(ref_mapq,alt_mapq,conf.int=TRUE)$estimate,5)
		#round(my.wilcox.effectsize(ref_mapq,alt_mapq,conf.int=TRUE),5)
		e=my.wilcox.effectsize(ref_mapq,alt_mapq,conf.int=TRUE)
		if (!is.na(e)){
			e<-e/sqrt(length(ref_mapq)+length(alt_mapq))
		}
		e
	}
	input$mapq_p=apply(input,1,my.wilcox.p)
	...
	my.wilcox.p <- function(x)
	{
	       ref_baseq=as.numeric(unlist(strsplit(as.character(x[10]),",")))
	       alt_baseq=as.numeric(unlist(strsplit(as.character(x[11]),",")))
	       #round(wilcox.test(ref_baseq,alt_baseq,conf.input=TRUE)$estimate,5)
		#round(my.wilcox.effectsize(ref_baseq,alt_baseq,conf.int=TRUE),5)
		e=my.wilcox.effectsize(ref_baseq,alt_baseq,conf.int=TRUE)
		if (!is.na(e)){
			e<-e/sqrt(length(ref_baseq)+length(alt_baseq))
		}
		e
	}
	input$baseq_p=apply(input,1,my.wilcox.p)
	...
	my.wilcox.p <- function(x)
	{
	       ref_baseq=as.numeric(unlist(strsplit(as.character(x[10]),",")))
	       ref_baseq1b=as.numeric(unlist(strsplit(as.character(x[12]),",")))
	       #round(wilcox.test(ref_baseq,ref_baseq1b,conf.int=TRUE)$estimate,5)
		#round(my.wilcox.effectsize(ref_baseq,ref_baseq1b,conf.int=TRUE),5)
		e=my.wilcox.effectsize(ref_baseq,ref_baseq1b,conf.int=TRUE)
		if (!is.na(e)){
			e<-e/sqrt(length(ref_baseq)+length(ref_baseq1b))
		}
		e
	...
	my.wilcox.p <- function(x)
	{
	       alt_baseq=as.numeric(unlist(strsplit(as.character(x[11]),",")))
	       alt_baseq1b=as.numeric(unlist(strsplit(as.character(x[13]),",")))
	       #round(wilcox.test(alt_baseq,alt_baseq1b,conf.int=TRUE)$estimate,5)
		e=my.wilcox.effectsize(alt_baseq,alt_baseq1b,conf.int=TRUE)
		if (!is.na(e)){
			e<-e/sqrt(length(alt_baseq)+length(alt_baseq1b))
		}
		e
	}
	input$alt_baseq1b_p=apply(input,1,my.wilcox.p)
	...
	my.fisher.p<- function(x)
	{
		...
		alt_minus <- as.numeric(unlist(as.character(x[17])))
		#round(fisher.test(cbind(c(ref_plus,ref_minus),c(alt_plus,alt_minus)))$p.value,5)
		round(fisher.test(cbind(c(ref_plus,ref_minus),c(alt_plus,alt_minus)))$estimate,5)
	}
	input$sb_p=apply(input,1,my.fisher.p)
	...
	my.wilcox.p <- function(x)
	{
	       mismatch_major=as.numeric(unlist(strsplit(as.character(x[22]),",")))
	       mismatch_minor=as.numeric(unlist(strsplit(as.character(x[23]),",")))-1
	       round(wilcox.test(mismatch_major,mismatch_minor,conf.int=TRUE)$estimate,5)
	}
	input$mismatches_p=apply(input,1,my.wilcox.p)
	...
	my.fisher.p<- function(x)
	{
		...
		alt_read2 <- as.numeric(unlist(as.character(x[27])))
		#round(fisher.test(cbind(c(ref_read1,ref_read2),c(alt_read1,alt_read2)))$p.value,5)
		round(fisher.test(cbind(c(ref_read1,ref_read2),c(alt_read1,alt_read2)))$estimate,5)
	}
	input$sb_read12_p=apply(input,1,my.fisher.p)
