...
if (length(args)!=4) {
	#stop("Rscript training_phasing_correction.R validated_phasble_sites_input prediction_model_phasingcorrection output_file_phasingcorrected", call.=FALSE)
	stop("Rscript training_phasing_correction.R trainset prediction_model_phasingcorrection output_file_phasingcorrected read_length", call.=FALSE)
